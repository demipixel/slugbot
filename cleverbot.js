...
class Cleverbot {
  constructor() {
    ...
    this.getCookie();
    request(
      'https://www.cleverbot.com/extras/conversation-social-min.js',
      (err, http, body) => {
  ...
  _send(msg, cb) {
    ...
    body += '&icognoid=wsf';
    body +=
      '&icognocheck=' + md5(body.substring(this.LOWER_MD5, this.UPPER_MD5));
    ...
    request.post(
      {
        ...
        headers: {
          'User-Agent':
            'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:7.0.1) Gecko/20100101 Firefox/7.0',
